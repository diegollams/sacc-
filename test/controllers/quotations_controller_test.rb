...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { customer_id: @quotation.customer_id, price: @quotation.price, square_meters: @quotation.square_meters }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { customer_id: @quotation.customer_id, price: @quotation.price, square_meters: @quotation.square_meters }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
