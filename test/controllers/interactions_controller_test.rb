...
class InteractionsControllerTest < ActionController::TestCase
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post :create, interaction: { customer_id: @interaction.customer_id, date: @interaction.date, kind: @interaction.kind, observation: @interaction.observation, time: @interaction.time }
    end
  ...
  test "should update interaction" do
    patch :update, id: @interaction, interaction: { customer_id: @interaction.customer_id, date: @interaction.date, kind: @interaction.kind, observation: @interaction.observation, time: @interaction.time }
    assert_redirected_to interaction_path(assigns(:interaction))
  end
